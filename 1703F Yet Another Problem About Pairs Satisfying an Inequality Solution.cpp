...
//[Key Idea : First lets store all the position where v[i] < i . Now only check we need to perform is to find out the number of i which are less than a[j]. So we can easily do this using lower bound. ]    
