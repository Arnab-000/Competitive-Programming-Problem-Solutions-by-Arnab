...
// [Key idea: Here only thing we need to worry about is what if maximum number and minimum are same or not. if they are same then for any n number, total number of combinations can be made by summing numbers from n-1 to 1.
// ]
