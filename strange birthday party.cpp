...
// [Key Idea: As cj is sorted, so best option is to pick gift with lower cost for higher k value friend. As we can always give less money to lower k value friend rather than giving high money to higher k value friend. ]
