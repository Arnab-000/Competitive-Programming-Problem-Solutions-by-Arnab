...
// [Key Idea : just twist the formula aj - ai = j - i to aj - j = ai - i 
// now we just need to count the number of same differences. Then using combinatorics
// formula. we can count the final answer.
// ]
