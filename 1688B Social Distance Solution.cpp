...
//[Key Idea: Lets think it as a sorted array of gap. For each person he needs to have a[i] gap on his left. As array a is increasing, for every man we can calculate the minimum gap he needs to his left. So with this, when we reach at end then we have to add it again to also calculate maximum gap the last man needs to his right]
